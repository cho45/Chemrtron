...
const useIndexerStore = /* @__PURE__ */ defineStore("indexer", () => {
  const currentIndexId = ref("mdn");
  const indexData = ref("");
  const metadata = ref(null);
  const searchQuery = ref("");
  const searchResults = ref([]);
  const isLoading = ref(false);
  const mdnIndexer = ref({
    id: "mdn",
    name: "MDN",
    color: "#00539f",
    index: async () => {
  ...
  async function loadIndex(id, reindex = false) {
...
const _hoisted_1 = { class: "chemrtron" };
...
const _hoisted_5 = { class: "results-container" };
const _hoisted_6 = {
  key: 0,
  class: "results"
};
...
const _hoisted_9 = { class: "result-url" };
const _hoisted_10 = {
  key: 1,
  class: "no-results"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("header", _hoisted_2, [
          createBaseVNode("h1", null, "Chemrtron - " + toDisplayString(unref(store).mdnIndexer.name), 1)
        ]),
        ...
        unref(store).isLoading ? (openBlock(), createElementBlock("div", _hoisted_4, "Loading index...")) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_5, [
          unref(store).searchResults.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_6, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(store).searchResults, (result, index) => {
              return openBlock(), createElementBlock("div", {
                key: index,
                class: "result-item",
                onClick: ($event) => openDocument(result[1])
              }, [
                createBaseVNode("div", {
                  class: "result-title",
                  innerHTML: result[2] || result[0]
                }, null, 8, _hoisted_8),
                createBaseVNode("div", _hoisted_9, toDisplayString(result[1]), 1)
              ], 8, _hoisted_7);
            }), 128))
          ])) : query.value && !unref(store).isLoading ? (openBlock(), createElementBlock("div", _hoisted_10, ' No results found for "' + toDisplayString(query.value) + '" ', 1)) : createCommentVNode("", true)
        ])
      ]);
    };
  }
